...
class E23_model extends MY_Model
{
    ...
    public $fields = [
        ...
        ['field' => 'observaciones',    'label' => 'Observaciones',     'rules' => 'trim|required|max_length[200]'],
        ['field' => 'recomendaciones',  'label' => 'Recomendaciones',   'rules' => 'trim|required|max_length[400]'],
